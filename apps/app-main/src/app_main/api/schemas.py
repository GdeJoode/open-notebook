"""
API request/response schemas for app-main.

Pure Pydantic models for API serialization (DTOs).
"""
...
class NoteAutoLinkResponse(BaseModel):
    ...
    min_similarity: float = Field(
        ..., description="Effective min cosine applied"
    )
