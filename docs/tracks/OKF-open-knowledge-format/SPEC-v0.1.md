<!-- Vendored copy of the Open Knowledge Format (OKF) v0.1 spec for offline
     reference (OKF-D1 pin). Source: GoogleCloudPlatform/knowledge-catalog
     okf/SPEC.md @ main, fetched 2026-07-24. Upstream is Apache-2.0 / CC-0 docs. -->
